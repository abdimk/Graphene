...
################################################################################
## Form generated from reading UI file 'main_interfaceDUzWSb.ui'
##
...
from Settings import icons_rc

class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        if not MainWindow.objectName():
            MainWindow.setObjectName(u"MainWindow")
        MainWindow.resize(644, 516)
...
"font: 75 8pt \"MS Shell Dlg 2\";")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 191, 772))
